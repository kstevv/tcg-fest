  ...
  return (
    <header className="sticky top-4 z-50">
      <div className="page-container">
        <div className="flex items-center justify-between rounded-2xl bg-gradient-to-b from-[var(--color-lessdark)_20%] to-[rgba(19,19,19,0.4)]
                        text-white shadow-xl ring-1 ring-white/10 backdrop-blur px-4 sm:px-6">
          {/* Brand */}
